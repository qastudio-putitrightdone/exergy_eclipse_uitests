...
public class PolicyMessageConstants {
    ...
    public static final String POLICY_ACTIVATION_MESSAGE="Activation was successfully";
    public static final String POLICY_REF_NOT_FOUND = "Policy reference number not found";
    public static final String LEVEL_CODE_ISSUE = "Please enter the Level Code";
}
